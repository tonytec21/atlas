...
#tabelaContas{ width:100% !important; table-layout:auto !important; min-width:0 !important; box-shadow:none; background:transparent; border-radius:0; border-collapse:separate; border-spacing:0; }
/* Cabeçalho CLARO (vence o gradiente escuro de ".table thead th !important") */
#tabelaContas thead th{ position:relative !important; cursor:pointer; background:#fff !important; color:#334155 !important; text-transform:none !important; letter-spacing:normal !important; font-weight:700 !important; font-size:.9rem !important; white-space:normal !important; border:none !important; border-bottom:1px solid rgba(0,0,0,.08) !important; padding:.75rem 26px .75rem .6rem !important; }
body.dark-mode #tabelaContas thead th{ background:#2c2f33 !important; color:#fff !important; border-bottom-color:rgba(255,255,255,.08) !important; }
#tabelaContas tbody td{ vertical-align:middle; }
/* Ações sempre por cima (garante clique) + em linha no desktop */
#tabelaContas td[data-cell="acoes"]{ white-space:nowrap; text-align:center; position:relative; z-index:3; }
#tabelaContas td[data-cell="acoes"] .btn-table{ margin:2px; }
...
#tabelaContas thead th.sorting::before,
#tabelaContas thead th.sorting_asc::before,
#tabelaContas thead th.sorting_desc::before{ content:"\2191"; position:absolute; right:13px; bottom:.5em; font-size:.8em; line-height:1; opacity:.3; }
#tabelaContas thead th.sorting::after,
#tabelaContas thead th.sorting_asc::after,
#tabelaContas thead th.sorting_desc::after{ content:"\2193"; position:absolute; right:6px; bottom:.5em; font-size:.8em; line-height:1; opacity:.3; }
#tabelaContas thead th.sorting_asc::before{ opacity:1; color:#2563eb; }
#tabelaContas thead th.sorting_desc::after{ opacity:1; color:#2563eb; }
body.dark-mode #tabelaContas thead th.sorting_asc::before,
body.dark-mode #tabelaContas thead th.sorting_desc::after{ color:#60a5fa; }
</style>
