...
$tabelas = [
    "INSERT INTO `manuais` (`id`, `titulo`, `descricao`, `categoria`, `caminho_video`, `data`, `status`, `ordem`) VALUES (12, 'Como criar ofícios', 'Neste tutorial, você aprenderá a criar Ofícios no sistema Atlas de forma prática e rápida. O vídeo detalha o processo completo, desde o acesso ao módulo específico até o preenchimento das informações necessárias, como destinatário, assunto e corpo do texto. Também serão abordadas opções de formatação e como salvar ou imprimir o ofício gerado.', 'Ofícios', 'anexos/Ofícios/COMO CRIAR OFICIOS NO SISTEMA ATLAS - 720p.mp4', '2024-09-28 20:08:58', 'ativo', 1);"
];
