...
$tabelas = [
    "ALTER TABLE ordens_de_servico_itens ADD COLUMN ordem_exibicao INT DEFAULT 0;",
    "ALTER TABLE logs_ordens_de_servico_itens ADD COLUMN ordem_exibicao INT DEFAULT 0;"
];
