...
$tabelas = [
   "ALTER TABLE guia_de_recebimento
	ADD COLUMN nome_portador VARCHAR(255) NULL AFTER documento_apresentante,
	ADD COLUMN documento_portador VARCHAR(50) NULL AFTER nome_portador;"
];
