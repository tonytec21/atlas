...
$tabelas = [
    "ALTER TABLE tarefas
    ADD COLUMN nivel_de_prioridade ENUM('Baixa', 'Média', 'Alta', 'Crítica') NOT NULL,
    ADD COLUMN sub_categoria ENUM('Não', 'Sim') NOT NULL,
    ADD COLUMN id_tarefa_principal INT NULL;",
    "ALTER TABLE comentarios
    ADD COLUMN id_tarefa_principal INT AFTER data_atualizacao;"
];
