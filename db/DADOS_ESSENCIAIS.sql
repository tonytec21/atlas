...
INSERT IGNORE INTO `cadastro_serventia` (`id`, `razao_social`, `cidade`, `status`, `cns`) VALUES
	(1, 'Serventia Extrajudicial do Ofício Único de Governador Newton Bello-MA', 'EsperantinÃ³polis-MA', 1, '030072');
...
INSERT IGNORE INTO `funcionarios` (`id`, `usuario`, `senha`, `nome_completo`, `cargo`, `nivel_de_acesso`, `status`) VALUES
	(1, 'ADMIN', 'MTMwNA==', 'Antonio José Martins Garcia', 'Tabelião e Registrador', 'administrador', 'ativo');
