        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6 form-floating">
                <label style="margin-top: 0.5rem; margin-bottom: .2rem;" for="nome"><i class="fas fa-user me-1"></i>&nbsp;Nome do Solicitante</label>  
            ...
            <!-- Serviço -->
            <div class="col-md-6 form-floating">
                <label style="margin-top: 0.5rem; margin-bottom: .2rem;" for="servico"><i class="fas fa-briefcase me-1"></i>&nbsp;Serviço</label>  
            ...
            <!-- Data original -->
            <div class="col-md-6 form-floating">
                <label style="margin-top: 0.5rem; margin-bottom: .2rem;" for="data_hora"><i class="far fa-clock me-1"></i>&nbsp;Data e Hora</label>  
            ...
            <!-- Status -->
            <div id="status" class="col-md-6 form-floating" style="display:none;">
              <label style="margin-top: 0.5rem; margin-bottom: .2rem;" for="status" class="text-muted">
            ...
            <div class="col-md-6 form-floating" id="grp_reagendamento" style="display:none">
                <label style="margin-top: 0.5rem; margin-bottom: .2rem;" for="data_reagendamento"><i class="far fa-clock me-1"></i>&nbsp;Nova Data</label>  
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-secondary text-white">
        <h5 class="modal-title"><i class="fas fa-eye me-1"></i>&nbsp;Detalhes do Agendamento</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
      </div>
