...
$MAPEAMENTO = [
  "Registro Civil" => [
    ...
    "Reconhecimento de Filiação" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Alteração de Patronímico" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Retificação Administrativa de Nascimento" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Suprimento Total de Nascimento" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Suprimento Parcial de Nascimento" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Restauração de Nascimento" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    "Busca de Nascimento" => ["livro","folha","termo","ano","nome_registrado","filiacao","data_evento","cartorio_origem"],
    ...
    "Suprimento Total de Casamento"  => ["livro","folha","termo","ano","nome_noivo","nome_noiva","data_evento","cartorio_origem"],
    "Suprimento Parcial de Casamento"  => ["livro","folha","termo","ano","nome_noivo","nome_noiva","data_evento","cartorio_origem"],
    ...
    "Busca de Casamento"  => ["livro","folha","termo","ano","nome_noivo","nome_noiva","data_evento","cartorio_origem"],
    ...
    "Suprimento Total de Óbito"      => ["livro","folha","termo","ano","nome_falecido","filiacao","data_evento","cartorio_origem"],
    "Suprimento Parcial de Óbito"      => ["livro","folha","termo","ano","nome_falecido","filiacao","data_evento","cartorio_origem"],
    "Restauração de Óbito"      => ["livro","folha","termo","ano","nome_falecido","filiacao","data_evento","cartorio_origem"],
    "Busca de Óbito"      => ["livro","folha","termo","ano","nome_falecido","filiacao","data_evento","cartorio_origem"]
  ],
  "Pessoas Jurídicas" => [
