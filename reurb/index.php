    ...
    <div class="container mt-4">
        ...
        <div id="sortable-cards" class="row">
            ...
            <div class="col-md-4 mb-3" id="card-pessoas">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="busca_pessoas.php" class="btn btn-secondary w-100">Acessar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3" id="card-imoveis">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="busca_imoveis.php" class="btn btn-info2 w-100">Acessar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3" id="card-processoadm">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        <i class="fa fa-folder-open-o fa-3x text-anotacoes" aria-hidden="true"></i>
                        <h5 class="card-title">Processo Administrativo</h5>
                        <a href="busca_processo_adm.php" class="btn btn-anotacoes w-100">Acessar</a>
                    </div>
                </div>
            </div>
