...
<div id="main" class="main-content">
    <div class="container">
        <h3>Editar Cédula</h3>
        <hr>
        <form method="POST" action="update_cedula.php">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="vencimento_cedula">Data de Vencimento:</label>
                    <input type="date" class="form-control" id="vencimento_cedula" name="vencimento_cedula" value="<?php echo htmlspecialchars($cedula['vencimento_cedula']); ?>" required>
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="avalista" name="avalista" value="<?php echo htmlspecialchars($cedula['avalista']); ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="vencimento_antecipado" name="vencimento_antecipado" rows="5" required><?php echo htmlspecialchars($cedula['vencimento_antecipado']); ?></textarea>
            </div>
            <div class="form-group">
                <label for="juros">Juros:</label>
                <textarea class="form-control" id="juros" name="juros" rows="5" required><?php echo htmlspecialchars($cedula['juros']); ?></textarea>
            </div>
            <div class="form-group">
                <label for="imovel_localizacao">Imóvel de Localização dos Bens:</label>
                <textarea class="form-control" id="imovel_localizacao" name="imovel_localizacao" rows="5" required><?php echo htmlspecialchars($cedula['imovel_localizacao']); ?></textarea>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        CKEDITOR.replace('vencimento_antecipado', {
            extraPlugins: 'htmlwriter',
            allowedContent: true,
            filebrowserUploadUrl: '/uploader/upload.php',
            filebrowserUploadMethod: 'form',
        ...
        CKEDITOR.replace('imovel_localizacao', {
            extraPlugins: 'htmlwriter',
            allowedContent: true,
            filebrowserUploadUrl: '/uploader/upload.php',
            filebrowserUploadMethod: 'form',
