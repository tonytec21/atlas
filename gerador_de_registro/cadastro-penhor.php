        ...
        <form method="POST" action="">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" id="vencimento_cedula" name="vencimento_cedula" required>
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="avalista" name="avalista" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="vencimento_antecipado" name="vencimento_antecipado" rows="5" required></textarea>
            </div>
            <div class="form-group">
                <label for="juros">Juros:</label>
                <textarea class="form-control" id="juros" name="juros" rows="5" required></textarea>
            </div>
            <div class="form-group">
                <label for="imovel_localizacao">Imóvel de Localização dos Bens:</label>
                <textarea class="form-control" id="imovel_localizacao" name="imovel_localizacao" rows="5" required></textarea>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
