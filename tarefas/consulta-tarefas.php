        ...
        <div class="modal-content">  
            ...
            <div class="modal-body">  
                ...
                <div class="status-section">  
                    ...
                    <div class="info-item">
                        <input type="text" class="form-control-modern" id="viewStatus" readonly> 
                    </div>  
                </div>  
...
function viewTask(taskToken) {
    $.ajax({
        ...
        $('#vincularOficioModal, #reciboEntregaModal, #guiaRecebimentoModal, #guiaHistoricoModal, #createSubTaskModal, #addCommentModal').on('hidden.bs.modal', function () {
