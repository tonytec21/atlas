...
<body>
<div class="container">
    <h3>Visualizar Ofício</h3>
    <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="data:application/pdf;base64,<?php echo base64_encode(ob_get_clean()); ?>" frameborder="0" style="width: 100%; height: 500px;"></iframe>
    </div>
    <h4>Anexos</h4>
    <div id="viewAttachments" class="list-group">
        <?php include 'get_attachments.php'; ?>
    </div>
</div>
