...
<div id="main" class="main-content">
    <div class="container">
        <div class="page-header">
            <h3>Indexador de Arquivos TXT</h3>
        </div>

        <form id="formProcessar" method="post" enctype="multipart/form-data">
            <div class="mb-4">
                <label for="arquivos" class="form-label">Selecione os arquivos TXT</label>
                <input type="file" id="arquivos" name="arquivos[]" class="form-control" multiple accept="text/plain">
            </div>
    ...
    $('#formProcessar').on('submit', function(e) {
        ...
        xhr.upload.addEventListener('progress', function(e) {
            if (e.lengthComputable) {
                ...
                $('.loading-overlay .loading-spinner span').text(`${percentComplete}%`);
            }
        });
        ...
        xhr.open('POST', 'processar_txt.php');
        xhr.send(formData);
    });
});
</script>
