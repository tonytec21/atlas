    ...
    <div class="container">  
        <!-- <div class="page-header">  
            <h1 class="page-title">  
                ...
                Exportar Carga de Nascimento  
            </h1>  
        </div>   -->

        <div class="d-flex justify-content-between align-items-center">
            <h3>Exportar Carga de Nascimento</h3>
            <a href="../nascimento/index.php" class="btn btn-secondary">
                <i class="fa fa-file-export" aria-hidden="true"></i> Indexador de Nascimento
            </a>
        </div>
        <hr>
        ...
        <div class="table-container">  
            <form method="post" action="gerar_carga.php" id="exportForm">  
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search'])) {  
                            ...
                            if ($result->num_rows > 0) {  
                                while ($row = $result->fetch_assoc()) {  
                                    ...
                                    echo '<td>  
                                            <div class="form-check">  
                                                <input type="checkbox" class="form-check-input" name="selected_ids[]" value="' . $row['id'] . '">  
                                            </div>  
                                          </td>';  
...
$(document).ready(function() {  
    // Inicialização do DataTables com configurações personalizadas  
    ...
    // Manipulação do formulário de exportação  
